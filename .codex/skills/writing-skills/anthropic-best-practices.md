...
Provide structures for output format. Match the level of strictness to your needs.
...
Output:
```
fix(reports): correct date formatting in exported summaries

Use normalized timestamps consistently across report generation
```
